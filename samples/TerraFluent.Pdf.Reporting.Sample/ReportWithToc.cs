namespace TerraFluent.Pdf.Reporting.Sample;
    ...
    public void Compose(IDocumentContainer container)
    {
        ...
        container.Page(p =>
        {
            ...
            p.Content().Column(col =>
            {
                ...
                col.Item().Text("This report demonstrates TerraFluent.Pdf.Reporting's Table of Contents generation feature. " +
                ...
                col.Item().H2("What is TerraFluent.Pdf.Reporting?");

                col.Item().Text("TerraFluent.Pdf.Reporting is a free, pure C# library designed for fast and reliable PDF generation. " +
                ...
                col.Item().Text("TerraFluent.Pdf.Reporting performs a two-pass layout: first it measures the document and collects all " +
        ...
        container.Page(p =>
        {
            ...
            p.Content().Column(col =>
            {
                ...
                col.Item().Text("TerraFluent.Pdf.Reporting provides six levels of headings with the following defaults:").Justify();
                ...
                col.Item().Table(table =>
                {
                    ...
                    table.Row(row =>
                    {
                        row.Cell().Padding(6).Text("TerraFluent.Pdf.Reporting License");
        ...
        container.Page(p =>
        {
            ...
            p.Content().Column(col =>
            {
                ...
                col.Item().Text("Internal links allow readers to click and jump to specific pages in the PDF. TerraFluent.Pdf.Reporting's " +
