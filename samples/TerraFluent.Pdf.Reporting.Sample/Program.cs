using TerraFluent.Pdf.Reporting.Sample.Samples;


//  TerraFluent.Pdf.Reporting Samples  -  PDFs from simple to complex.
//  Output directory: first command-line argument, or Desktop\SamplePdfReports by default.


string desktop = Environment.GetFolderPath(Environment.SpecialFolder.Desktop);
string sampleDir = args.Length > 0 ? args[0] : Path.Combine(desktop, "SamplePdfReports");
...
Console.WriteLine("TerraFluent.Pdf.Reporting Samples - generating ten PDFs to Desktop...");
Console.WriteLine();
