...
internal static class UnicodeShowcase
{
    internal static void Generate(string path)
    {
        ...
        [
            ...
            ("U+2122", "0x99", "\u2122", "Trade mark sign",             "TerraFluent.Pdf.Reporting\u2122"),
                ...
                col.Item().Background(brand).PaddingVertical(10).PaddingHorizontal(14)
                   .Row(hdr =>
                   {
                       hdr.RelativeItem().AlignMiddle()
                          .Text("TerraFluent.Pdf.Reporting — Unicode & WinAnsiEncoding Showcase")
        ...
        void Caption(TerraFluent.Pdf.Reporting.Infra.IContainer c, string text) =>
        ...
        {
            // ── Metadata ──────────────────────────────────────────────────────
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Unicode & WinAnsiEncoding Showcase");
            ...
            doc.Page(page =>
            {
                ...
                page.Content().PaddingTop(12).Column(col =>
                {
                    ...
                    col.Item().Background(light).Border(0.5, gridLine).Padding(10).Column(box =>
                    {
                        ...
                        {
                            t.Span("TerraFluent.Pdf.Reporting ships with ").FontColor(muted);
...
internal sealed class UnicodeSectionHeader(string hexColor, string title)
    : TerraFluent.Pdf.Reporting.Infra.IComponent
{
