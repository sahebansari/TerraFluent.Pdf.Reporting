...
internal static class EncryptionShowcase
{
    ...
    private static void GenerateA(string path)
    {
        PdfDocument.Create(doc =>
        {
            ...
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Password Protected (All Permissions)");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator");
    ...
    private static void GenerateE(string path)
    {
        PdfDocument.Create(doc =>
        {
            ...
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Legacy AES-128 Encryption");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            ...
            doc.Page(page =>
            {
                ...
                page.Content().PaddingTop(16).Column(col =>
                {
                    ...
                    col.Item().Text(t =>
                    {
                        t.Span("TerraFluent.Pdf.Reporting encrypts with ").FontColor(Muted);
    ...
    private static void GenerateB(string path)
    {
        PdfDocument.Create(doc =>
        {
            ...
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — No Open Password, Restricted Permissions");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator");
    ...
    private static void GenerateC(string path)
    {
        PdfDocument.Create(doc =>
        {
            ...
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Print-Only Protection");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator");
    ...
    private static void GenerateD(string path)
    {
        PdfDocument.Create(doc =>
        {
            ...
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Fully Restricted");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator");
        ...
        string path, string pathA, string pathB, string pathC, string pathD, string pathE)
    {
        ...
        PdfDocument.Create(doc =>
        {
            doc.MetadataTitle("TerraFluent.Pdf.Reporting — Encryption & Password Protection Showcase");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            ...
            doc.MetadataKeywords("pdf; encryption; password; permissions; AES; security; TerraFluent.Pdf.Reporting");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator");
            ...
            doc.Page(page =>
            {
                ...
                page.Content().PaddingTop(16).Column(col =>
                {
                    ...
                    col.Item().Text(t =>
                    {
                        t.Span("By default, TerraFluent.Pdf.Reporting derives a 32-byte ").FontColor(Muted);
        ...
        page.Header().Column(col =>
        {
            col.Item().Background(Brand).PaddingVertical(10).PaddingHorizontal(14)
               .Row(hdr =>
               {
                   ...
                   {
                       t.Item().Text("TerraFluent.Pdf.Reporting — Encryption Showcase")
    ...
    private static void PageFooter(PageDescriptor page)
    {
        ...
        {
            row.RelativeItem()
               .Text("TerraFluent.Pdf.Reporting — AES-256 Encryption Showcase")
