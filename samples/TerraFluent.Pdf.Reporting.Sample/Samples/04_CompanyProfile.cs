        ...
        PdfDocument.Create(doc =>
        {
            doc.Page(page =>
            {
                ...
                page.Header().Column(col =>
                {
                    ...
                    if (File.Exists(headerImg))
                        ...
                        col.Item().Background(brand).Padding(30)
                           .AlignCenter().Text("TERRAFLUENT CO.").Bold().FontSize(28).FontColor(Color.White);
                ...
                page.Content().Padding(40).Column(col =>
                {
                    ...
                    col.Item().AlignCenter()
                       .Text("Established 2010  ·  San Francisco, CA  ·  www.terrafluent.example")
                    ...
                    col.Item().Background(light).Padding(12).Column(about =>
                    {
                        ...
                        about.Item().PaddingTop(4).Text(
                            "TerraFluent Co. is a leading software engineering firm specialising in " +
                    ...
                    col.Item().AlignCenter()
                       .Text("Contact us: hello@terrafluent.example  |  +1 (415) 000-0000")
                       .FontColor(muted).FontSize(10);
                });
