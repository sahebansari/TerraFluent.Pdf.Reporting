...
internal static class ReportWithBookmarks
{
    internal static void Generate(string path)
    {
        ...
        {
            doc.MetadataTitle("TerraFluent.Pdf.Reporting Developer Guide");
            doc.MetadataAuthor("TerraFluent.Pdf.Reporting Engineering Team");
            doc.MetadataSubject("Comprehensive guide to TerraFluent.Pdf.Reporting features and APIs");
            doc.MetadataKeywords("pdf; terra; dotnet; guide; documentation");
            doc.MetadataCreator("TerraFluent.Pdf.Reporting Sample Generator v1.0");
            ...
            doc.Page(page =>
            {
                ...
                page.Header().Background(brand).Padding(10).Column(h =>
                    h.Item().AlignCenter().Text("TERRAFLUENT DEVELOPER GUIDE")
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(12).Text(
                        "This guide provides a comprehensive overview of TerraFluent.Pdf.Reporting, " +
                        "a pure-C# document generation library with zero runtime dependencies. " +
                        "TerraFluent.Pdf.Reporting enables developers to create professional-quality PDF documents " +
                        "programmatically using a fluent, composable API. From simple text blocks " +
                        "to complex multi-page tables with repeating headers, TerraFluent.Pdf.Reporting handles " +
                    ...
                    col.Item().PaddingTop(8).Text(
                        "To begin using TerraFluent.Pdf.Reporting, add the NuGet package to your project " +
                ...
                {
                    t.Span("TerraFluent.Pdf.Reporting Developer Guide  |  ").FontSize(9).FontColor(muted);
            ...
            doc.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(10).Text(
                        "Install TerraFluent.Pdf.Reporting via NuGet: dotnet add package TerraFluent.Pdf.Reporting. " +
                    ...
                    col.Item().PaddingTop(10).Text(
                        ...
                        "Start with PdfDocument.Create(), define one or more pages, and add content " +
            ...
            doc.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(8).Text(
                        "TerraFluent.Pdf.Reporting provides comprehensive typographic controls: font size, colour (hex or " +
                    ...
                    col.Item().PaddingTop(8).Text(
                        "Embed PNG (RGB) and JPEG images directly. TerraFluent.Pdf.Reporting decodes PNGs and recompresses " +
            ...
            doc.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(8).Text(
                        "Tables are the most powerful layout primitive in TerraFluent.Pdf.Reporting. Define columns using " +
            ...
            doc.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(8).Text(
                        "TerraFluent.Pdf.Reporting uses a two-pass rendering strategy: the first pass measures all content " +
                    ...
                    col.Item().PaddingTop(8).Text(
                        "TerraFluent.Pdf.Reporting is designed for high-throughput scenarios: PDFs are generated entirely in-memory " +
            ...
            doc.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().PaddingTop(8).Text(
                        "The TerraFluent.Pdf.Reporting API surface is intentionally small and composable. Key entry points:\n" +
                        "• PdfDocument.Create() — starts a new document builder.\n" +
                    ...
                    col.Item().PaddingTop(8).Text(
                        "Upgrading from TerraFluent.Pdf.Reporting 1.x to 2.0? Key breaking changes include the new descriptor " +
                    ...
                    col.Item().PaddingTop(10).Background(accent).Padding(8).AlignCenter()
                        .Text("Thank you for choosing TerraFluent.Pdf.Reporting!")
