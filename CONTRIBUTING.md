# Contributing to TerraFluent.Pdf.Reporting
...
├── src/
│   └── TerraFluent.Pdf.Reporting/
│       ├── Core/          # Fluent API — descriptors, extension methods, PdfDocument entry point
│       ├── Drawing/       # PDF rendering — PdfWriter, PdfPage, FontMetrics, image decoders
...
├── tests/
│   └── TerraFluent.Pdf.Reporting.Tests/    # xUnit test projects
├── samples/
│   └── TerraFluent.Pdf.Reporting.Sample/   # Six sample PDFs covering all major features
...
- **No third-party dependencies** in the library project — TerraFluent.Pdf.Reporting has zero
...
Tests live in `tests/TerraFluent.Pdf.Reporting.Tests/` and use **xUnit**.
...
Open a [GitHub Issue](https://github.com/sahebansari/TerraFluent.Pdf.Reporting/issues) and include:

- TerraFluent.Pdf.Reporting version
- .NET runtime version
...
Open a [GitHub Issue](https://github.com/sahebansari/TerraFluent.Pdf.Reporting/issues) with the
