...
TerraFluent.Pdf.Reporting provides a fluent **Canvas API** for drawing vector graphics directly inside
...
upper-left corner of the canvas element — consistent with TerraFluent.Pdf.Reporting's layout
coordinate system.
...
The `10_VectorGraphicsShowcase.cs` sample in `samples/TerraFluent.Pdf.Reporting.Sample/Samples/`
