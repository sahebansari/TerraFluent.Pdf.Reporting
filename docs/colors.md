...
TerraFluent.Pdf.Reporting ships a full **Material Design**-inspired colour palette as static string
constants in the `TerraFluent.Pdf.Reporting.Helpers.Color` class. All values are CSS hex strings
