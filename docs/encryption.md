...
TerraFluent.Pdf.Reporting encrypts documents with **AES-256** using the PDF Standard Security
...
Call `container.Encrypt(options)` once inside the `PdfDocument.Create` callback.
