...
/// <see cref="TerraFluent.Pdf.Reporting.Core.ColumnDescriptor"/>, or via
/// <c>col.Item().PageBreak()</c> using the <see cref="TerraFluent.Pdf.Reporting.Core.ContainerExtensions"/>
...
internal sealed class PageBreak : Element
{
    ...
    /// handled by <see cref="TerraFluent.Pdf.Reporting.Core.DocumentComposer"/>.</summary>
