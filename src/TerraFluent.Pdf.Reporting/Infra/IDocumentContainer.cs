...
/// Passed to <see cref="IDocument.Compose"/> and to <c>PdfDocument.Create</c>.
/// </summary>
public interface IDocumentContainer
{
    ...
    /// previous settings.  When a <see cref="TerraFluent.Pdf.Reporting.Core.EncryptionOptions.UserPassword"/>
    ...
    void Encrypt(TerraFluent.Pdf.Reporting.Core.EncryptionOptions options);
}
