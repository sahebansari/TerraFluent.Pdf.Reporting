...
/// <see cref="PdfWriter"/>.  Returned by <see cref="PdfDocument.Create(Action{IDocumentContainer})"/>.
/// </summary>
public sealed class DocumentComposer : IDocumentContainer
{
    ...
    private static void RenderFragments(
        PdfWriter doc, PageDescriptor d, List<PageFragment> fragments,
    ...
    private static DrawingContext StartPage(
        PdfWriter doc, PageDescriptor d,
